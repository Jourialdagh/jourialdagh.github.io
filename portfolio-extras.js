...
adversarial training, Hadoop/Spark, C++, Linux, Cisco networking. She is actively available and seeking internships AND work opportunities in AI/ML
research, cybersecurity / security engineering, and startups — recruiters are encouraged to reach out to her directly to work together.
She was born on 31 October 2004 (in Jeddah, Saudi Arabia), and her nationality is Jordanian. Contact: jouri.w2004@gmail.com, GitHub Jourialdagh,
...
const KB = [
  ...
  {
    keys: ['internship','intern','hire','hiring','available','availab','opportunit','join','recruit','position','role','open to','looking for','work','employ','freelance','contract'],
    a: `Yes — Jouri is <strong>actively available</strong> for both <strong>internships and work opportunities</strong> in AI/ML research labs, cybersecurity & security engineering, and startups. She's open to research and applied roles, and would love to hear from you. Please <strong>reach out directly</strong>: <a href="mailto:jouri.w2004@gmail.com">jouri.w2004@gmail.com</a> · <a href="https://www.linkedin.com/in/jouri-aldaghma-b7a8b8307/" target="_blank">LinkedIn</a>.`
  },
  {
  ...
  {
    keys: ['age','old','born','birth','birthday','birthdate','date of birth','dob','young'],
    a: `Jouri was born on <strong>31 October 2004</strong>, which makes her <strong>21</strong>. She's an early-career engineer with a research track record well ahead of her age.`
  },
  {
    keys: ['national','nationality','citizen','passport','jordan','jordanian','where from','country','origin'],
    a: `Jouri is <strong>Jordanian</strong> by nationality. She was <strong>born in Jeddah, Saudi Arabia</strong> on 31 October 2004.`
  },
  {
    keys: ['where','located','location','live','based','jeddah','saudi','from where'],
    a: `Jouri was <strong>born in Jeddah, Saudi Arabia</strong> and is <strong>Jordanian</strong> by nationality. She's open to opportunities — reach her at <a href="mailto:jouri.w2004@gmail.com">jouri.w2004@gmail.com</a>.`
  },
  {
